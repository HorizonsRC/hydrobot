...
NOTE: Hydrobot 0.7.1 supports only Water Temperature processing at the moment,
...
#. In your favourite shell (if you don't know what that is, use powershell -
   ...
   this python interpreter and name it "hydrobot0.7.1". It's important that
   ...
   "Hydrobot" folder in the C: drive, which would need the command::
    ...
    python -m venv C:/Hydrobot/hydrobot0.7.1/

#. Activate this virtual environment. In powershell this should be something
   like::

    C:/Hydrobot/hydrobot0.7.1/Scripts/Activate.ps1
