...
NOTE: Hydrobot 0.9.9 does not support all NEMS data sources currently,
...
#. In your favourite shell (if you don't know what that is, use powershell -
   ...
   this python interpreter and name it "hydrobot0.9.9". It's important that
   ...
   "Hydrobot" folder in the C: drive, which would need the command::
    ...
    python -m venv C:/Hydrobot/hydrobot0.9.9/
    cd C:/Hydrobot/hydrobot0.9.9/

#. Activate this virtual environment. In powershell this should be something
   like::

    C:/Hydrobot/hydrobot0.9.9/Scripts/Activate.ps1
